    ...
    <div>
      ...
      <div className="max-w-full flex flex-wrap justify-center">
        {paginatedCountries.map((country: Country) => (
          <div
            key={country.code}
            className={`flex flex-col border-2 text-center justify-center w-56 h-48 bg-slate-400 bg-opacity-20 hover:bg-opacity-75 focus:border-red-400 transform duration-300 m-2 p-2 cursor-pointer ${
          ...
          >
           ...
           ${
            clickedCountry === country.code ? "border-neutral-400" : ""
           } `}>
      ...
      <div className="flex justify-center mt-4">
        ...
        <button
          onClick={() => handlePageChange(currentPage + 1)}
          disabled={currentPage * PAGE_SIZE >= filteredCountries.length}
